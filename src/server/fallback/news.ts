...
export const newsFallback: NewsArticle[] = [
  {
    ...
    heroImage: "/images/backgrounds/background_news.webp",
    gallery: [{ imgSrc: "/images/backgrounds/background_news.webp" }],
    body: `
...
`.trim(),
  ...
  },
  {
    ...
    heroImage: "/images/backgrounds/background_about.webp",
    gallery: [{ imgSrc: "/images/backgrounds/background_about.webp" }],
    body: `

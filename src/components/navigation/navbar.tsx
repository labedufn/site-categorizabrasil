...
export function Navbar() {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 w-full flex items-center h-20 shadow-sm z-40 bg-white/60 backdrop-filter backdrop-blur-xl">
        <nav className="relative mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex gap-x-5 justify-between items-center">
          <Link href="/">
            <Logo.default className="w-26 h-26" />
          </Link>

  ...
  return (
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col md:flex-row gap-16">
        ...
        <div className="md:w-1/2 space-y-12 text-gray-700 md:py-8">
          <h1 className="text-primary font-semibold text-2xl sm:text-3xl md:text-4xl">Quem somos</h1>
          <p>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <a href="tel:+243" className="flex gap-x-6 items-start" rel="noreferer">
              ...
              <div className="space-y-0.5 flex flex-col flex-1">
                ...
                <p className="font-semibold text-gray-900 text-lg">+243 xx xx xx xxx</p>
              </div>
            </a>
          ...
          <div className="flex">
            <Link href="#" className="px-5 h-11 flex items-center bg-gray-900 rounded-lg text-white">
              Know more
            </Link>
          </div>
        </div>
